    ...
    public function getQueryBuilderBySearchData($searchData)
    {
        ...
        if (isset($searchData['name']) && Str::isNotBlank($searchData['name'])) {
            ...
            foreach ($keywords as $index => $keyword) {
                ...
                $qb
                    ->andWhere(sprintf('NORMALIZE(p.name) LIKE NORMALIZE(:%s) OR NORMALIZE(p.search_word) LIKE NORMALIZE(:%s) OR NORMALIZE(p.description_detail) LIKE NORMALIZE(:%s) OR NORMALIZE(p.free_area) LIKE NORMALIZE(:%s) OR NORMALIZE(pc.code) LIKE NORMALIZE(:%s)', $key, $key, $key, $key, $key))
