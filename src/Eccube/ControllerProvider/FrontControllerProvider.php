...
class FrontControllerProvider implements ControllerProviderInterface
{
    public function connect(Application $app)
    {
        ...
        $c->match('/block/main_menu', '\Eccube\Controller\Block\MainMenuController::index')->bind('block_main_menu');

        $c->match('/block/all_category', '\Eccube\Controller\Block\AllMenuController::index')->bind('block_all_category');
        $c->match('/block/all_category_sm', '\Eccube\Controller\Block\AllMenuSMController::index')->bind('block_all_category_sm');
