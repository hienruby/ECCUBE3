...
class FrontControllerProvider implements ControllerProviderInterface
{
    public function connect(Application $app)
    {
        ...
        $c->match('/block/sp_body_category', '\Eccube\Controller\Block\SpCatController::index')->bind('block_sp_body_category');
        $c->match('/block/top_contents_category', '\Eccube\Controller\Block\CatTopController::index')->bind('block_top_contents_category');
        $c->match('/block/category_left', '\Eccube\Controller\Block\CatLeftController::index')->bind('block_category_left');
         $c->match('/block/susume_category', '\Eccube\Controller\Block\SusumeCateController::index')->bind('block_susume_category');
           $c->match('/block/search', '\Eccube\Controller\Block\SearchlastController::index')->bind('block_search');
