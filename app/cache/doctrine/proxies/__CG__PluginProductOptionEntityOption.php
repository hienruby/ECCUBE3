...
class Option extends \Plugin\ProductOption\Entity\Option implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Plugin\\ProductOption\\Entity\\Option' . "\0" . 'optionCategories', '' . "\0" . 'Plugin\\ProductOption\\Entity\\Option' . "\0" . 'id', '' . "\0" . 'Plugin\\ProductOption\\Entity\\Option' . "\0" . 'name', '' . "\0" . 'Plugin\\ProductOption\\Entity\\Option' . "\0" . 'manage_name', '' . "\0" . 'Plugin\\ProductOption\\Entity\\Option' . "\0" . 'description', '' . "\0" . 'Plugin\\ProductOption\\Entity\\Option' . "\0" . 'Type', '' . "\0" . 'Plugin\\ProductOption\\Entity\\Option' . "\0" . 'pricedisp_flg', '' . "\0" . 'Plugin\\ProductOption\\Entity\\Option' . "\0" . 'description_flg', '' . "\0" . 'Plugin\\ProductOption\\Entity\\Option' . "\0" . 'is_required', '' . "\0" . 'Plugin\\ProductOption\\Entity\\Option' . "\0" . 'require_min', '' . "\0" . 'Plugin\\ProductOption\\Entity\\Option' . "\0" . 'require_max', '' . "\0" . 'Plugin\\ProductOption\\Entity\\Option' . "\0" . 'rank', '' . "\0" . 'Plugin\\ProductOption\\Entity\\Option' . "\0" . 'del_flg', '' . "\0" . 'Plugin\\ProductOption\\Entity\\Option' . "\0" . 'create_date', '' . "\0" . 'Plugin\\ProductOption\\Entity\\Option' . "\0" . 'update_date', '' . "\0" . 'Plugin\\ProductOption\\Entity\\Option' . "\0" . 'OptionCategories', '' . "\0" . 'Plugin\\ProductOption\\Entity\\Option' . "\0" . 'ProductOptions', '' . "\0" . 'Plugin\\ProductOption\\Entity\\Option' . "\0" . 'Creator', '' . "\0" . 'Plugin\\ProductOption\\Entity\\Option' . "\0" . 'defaultCategorys', '' . "\0" . 'Plugin\\ProductOption\\Entity\\Option' . "\0" . 'disableCategory');
        }
    ...
    public function setRequireMin($min)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRequireMin', array($min));
    ...
    public function getRequireMin()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRequireMin', array());
    ...
    public function setRequireMax($max)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRequireMax', array($max));
    ...
    public function getRequireMax()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRequireMax', array());
