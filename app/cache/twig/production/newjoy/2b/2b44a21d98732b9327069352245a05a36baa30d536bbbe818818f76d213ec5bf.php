...
/* __string_template__557d666c8fa3481f08db0162301d0675332b595044f5c3b996c8dd1303a29a0f */
class __TwigTemplate_3a7a41754daae189159edc0bc798d6052766a7a756db43da7b9efbe7b4004bbf extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 22
        $this->parent = $this->loadTemplate("default_frame.twig", "__string_template__557d666c8fa3481f08db0162301d0675332b595044f5c3b996c8dd1303a29a0f", 22);
        $this->blocks = array(
    ...
    <div id=\"login_wrap\" class=\"container-fluid\">
        ...
        echo "                    <div id=\"customer_box__body\" class=\"column\">
                        <div id=\"customer_box__body_inner\" class=\"column_inner clearfix\">
                            ...
                            <div id=\"customer_box__login_email\" class=\"form-group\">
                                ";
        // line 45
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\FormExtension')->renderer->searchAndRenderBlock($this->getAttribute(($context["form"] ?? null), "login_email", array()), 'widget', array("attr" => array("placeholder" => "メールアドレス")));
        echo " <br class=\"sp\">
                            </div>
        ...
        echo "                            <div id=\"customer_box__login_button\" class=\"btn_area\">
                                <p><button type=\"submit\" class=\"btn btn-login btn-block btn-lg\">ログイン</button></p>
        ...
        if ($this->env->getExtension('Symfony\Bridge\Twig\Extension\SecurityExtension')->isGranted("IS_AUTHENTICATED_REMEMBERED")) {
            ...
            echo "\" class=\"btn btn-login btn-block btn-lg\">ゲスト購入</a></p>
                        </div>
                    </div>
                </div><!-- /.col -->
                ";
...
";
    ...
    {
        return "__string_template__557d666c8fa3481f08db0162301d0675332b595044f5c3b996c8dd1303a29a0f";
    }
    ...
    {
        return new Twig_Source("", "__string_template__557d666c8fa3481f08db0162301d0675332b595044f5c3b996c8dd1303a29a0f", "");
    }
}
