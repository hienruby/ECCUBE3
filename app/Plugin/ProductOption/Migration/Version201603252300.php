...
class Version201603252300 extends AbstractMigration
{
    ...
    public function postUp(Schema $schema)
    {
        ...
        $this->connection->insert('plg_productoption_mtb_type' , array('id' => 5 , 'name' => 'チェックボックス', 'rank' => 3));
        $this->connection->insert('plg_productoption_mtb_type' , array('id' => 3 , 'name' => 'テキストボックス', 'rank' => 4));
        $this->connection->insert('plg_productoption_mtb_type' , array('id' => 4 , 'name' => 'テキストエリア', 'rank' => 5));
    }
