            ...
            if ($form->isValid()) {
                ...
                if ($status) {
                    if($OriginOption->getId() > 0){
                        if($OriginOption->getType()->getId() != $TargetOption->getType()->getId()){
                            if($OriginOption->getType()->getId() == 5){
                            ...
                            if(
                                ($OriginOption->getType()->getId() == 1 ||
                                 $OriginOption->getType()->getId() == 2 ||
                                 $OriginOption->getType()->getId() == 5) &&
                                ($TargetOption->getType()->getId() == 3 ||
                                 $TargetOption->getType()->getId() == 4 ||
                                 $TargetOption->getType()->getId() == 6 ||
                                 $TargetOption->getType()->getId() == 7
                                )
                               ){
                                $OptionCategories = $TargetOption->getOptionCategories();
                                if(count($OptionCategories) > 0){
                                    foreach($OptionCategories as $OptionCategory){
                                        ...
                                        $app['orm.em']->remove($OptionCategory);
                                    }
                                }
                                $app['orm.em']->persist($TargetOption);
                            }
                        }
                    }
                    $app['orm.em']->flush();
