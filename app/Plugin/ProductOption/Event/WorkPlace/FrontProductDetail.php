                        ...
                        foreach($data as $option_key => $value){
                            if(strpos($option_key,'productoption') !== false){
                                ...
                                if($Option){
                                    ...
                                    }elseif($Option->getType()->getId() == 3 || $Option->getType()->getId() == 4 || $Option->getType()->getId() == 7){
                                        if(strlen($value) == 0)$add = false;
                                    }elseif($Option->getType()->getId() == 5){
                                        if(count($value) == 0)$add = false;
                                    }elseif($Option->getType()->getId() == 6){
                                    ...
                                    if($add){
                                        if(is_array($value)){
                                            ...
                                            $Options[$option_key] = $value->format('Y-m-d');
                                        }else{
